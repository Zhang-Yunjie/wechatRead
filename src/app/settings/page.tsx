...
export default async function SettingsPage() {
  ...
  const status = { weread: getWeReadCredentialStatus(), aiConfigured: hasAIConfiguration(), databasePath: process.env.READING_DB_PATH ?? "data/reading.db", lastSync: lastSync ? { status: lastSync.status, finishedAt: lastSync.finishedAt } : null };
